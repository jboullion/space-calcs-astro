...
// 1. Fuel Mass?
// 2. Population energy consumption per person? Create second "Maintenance Energy" value. Rename current "Energy" to "Engine Energy"?
// 3. Create an "Advanced" tab that allows for more complex calculations. Such as: Population growth, water requirements, etc.
...
function setupThreeJS() {
    ...
    three.canvas = document.getElementById('star-travel-canvas');

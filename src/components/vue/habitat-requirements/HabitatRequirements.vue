      ...
      <div class="mb-5 px-2 rounded border">
        <div id="mission" class="habitat__mission form-section active">
          ...
          <div class="calc-toggle" v-show="showLocation">
            ...
            <div class="form-check form-switch mb-3" v-if="isRegolithAvailable">
              <input
            ...
            <div class="form-check form-switch mb-3" v-if="isCO2Available">
              <input
                class="form-check-input"
                type="checkbox"
            ...
            <div class="mb-3">
              <label for="crew-num" class="form-label">Crew Number</label>
              <input
                type="number"
                class="form-control"
                id="crew-num"
            ...
            <div class="mb-3">
              <label for="payload-mass" class="form-label">Payload mass</label>
              <div class="input-group">
                <input
                  type="number"
                  class="form-control"
        ...
        <div id="support" class="habitat__life-support form-section">
          ...
          <div class="calc-toggle" v-show="showSupport">
            ...
            <div class="mb-3">
              <label for="support-eva" class="form-label">EVA options</label>
              <select
                class="form-select"
                id="support-eva"
        ...
        <div id="electrical" class="habitat__life-support form-section">
          ...
          <div class="calc-toggle" v-show="showElectrical">
            ...
            <div class="mb-3">
              <label for="electrical-primary-elements" class="form-label"
            ...
            <div class="mb-3">
              <label for="electrical-storage-percent" class="form-label"
    ...
    <div class="col-lg-8">
      ...
      >
        ...
        <div class="result-chart">
          <div id="totals-chart" style="width: 100%; height: 400px"></div>
        </div>
          ...
          <table class="table">
            <thead>
              <tr>
                <th></th>
                <th>Mass (kg)</th>
                <th style="min-width: 100px">Mass - ISRU (kg)</th>
            ...
            <tfoot v-show="showDetails">
              <tr
                class="toggleDetails"
                @click="showStructureTotals = !showStructureTotals"
              >
                <th>+ Structure</th>
                <td>{{ formatNumber(results.structure.totals.mass) }}</td>
                <td>{{ formatNumber(results.structure.totals.massISRU) }}</td>
                <td>-</td>
                <td>{{ formatNumber(results.structure.totals.volume) }}</td>
              </tr>
              <tr v-show="showStructureTotals">
                <th>- Pressure vessel</th>
                <td>{{ formatNumber(results.structure.vessel.mass) }}</td>
                <td>{{ formatNumber(results.structure.vessel.massISRU) }}</td>
                <td>-</td>
                <td>-</td>
              </tr>
              <tr v-show="showStructureTotals">
                <th>- Insulation and MMOD shielding</th>
                <td>{{ formatNumber(results.structure.insulation.mass) }}</td>
                <td>
                  {{ formatNumber(results.structure.insulation.massISRU) }}
                </td>
                <td>-</td>
                <td>-</td>
              </tr>
              <tr v-show="showStructureTotals">
                ...
                <td>{{ formatNumber(results.structure.shielding.mass) }}</td>
                <td>
                  {{ formatNumber(results.structure.shielding.massISRU) }}
                </td>
                <td>-</td>
                <td>-</td>
              </tr>
              ...
              <tr>
                ...
                <td>{{ formatNumber(results.avionics.mass) }}</td>
                <td>{{ formatNumber(results.avionics.massISRU) }}</td>
                <td>{{ formatNumber(results.avionics.power) }}</td>
                <td>{{ formatNumber(results.avionics.volume) }}</td>
              </tr>
              <tr>
                <td colspan="5">&nbsp;</td>
              </tr>
              ...
              >
                <th>+ ECLSS systems</th>
                <td>{{ formatNumber(results.eclss.totals.mass) }}</td>
                <td>{{ formatNumber(results.eclss.totals.massISRU) }}</td>
                <td>{{ formatNumber(results.eclss.totals.power) }}</td>
                <td>{{ formatNumber(results.eclss.totals.volume) }}</td>
              </tr>
              <tr v-show="showEclssTotals">
                <th>- Air</th>
                <td>{{ formatNumber(results.eclss.air.mass) }}</td>
                <td>{{ formatNumber(results.eclss.air.massISRU) }}</td>
                <td>{{ formatNumber(results.eclss.air.power) }}</td>
                <td>{{ formatNumber(results.eclss.air.volume) }}</td>
              </tr>
              <tr v-show="showEclssTotals">
                <th>- Food</th>
                <td>{{ formatNumber(results.eclss.food.mass) }}</td>
                <td>{{ formatNumber(results.eclss.food.massISRU) }}</td>
                <td>{{ formatNumber(results.eclss.food.power) }}</td>
                <td>{{ formatNumber(results.eclss.food.volume) }}</td>
              </tr>
              <tr v-show="showEclssTotals">
                <th>- Thermal</th>
                <td>{{ formatNumber(results.eclss.thermal.mass) }}</td>
                <td>{{ formatNumber(results.eclss.thermal.massISRU) }}</td>
                <td>{{ formatNumber(results.eclss.thermal.power) }}</td>
                <td>{{ formatNumber(results.eclss.thermal.volume) }}</td>
              </tr>
              <tr v-show="showEclssTotals">
                <th>- Waste</th>
                <td>{{ formatNumber(results.eclss.waste.mass) }}</td>
                <td>{{ formatNumber(results.eclss.waste.massISRU) }}</td>
                <td>{{ formatNumber(results.eclss.waste.power) }}</td>
                <td>{{ formatNumber(results.eclss.waste.volume) }}</td>
              </tr>
              <tr v-show="showEclssTotals">
                <th>- Water</th>
                <td>{{ formatNumber(results.eclss.water.mass) }}</td>
                <td>{{ formatNumber(results.eclss.water.massISRU) }}</td>
                <td>{{ formatNumber(results.eclss.water.power) }}</td>
                <td>{{ formatNumber(results.eclss.water.volume) }}</td>
              </tr>
              <tr v-show="showEclssTotals">
                <th>- EVA</th>
                <td>{{ formatNumber(results.eclss.eva.mass) }}</td>
                <td>{{ formatNumber(results.eclss.eva.massISRU) }}</td>
                <td>{{ formatNumber(results.eclss.eva.power) }}</td>
                <td>{{ formatNumber(results.eclss.eva.volume) }}</td>
              </tr>
              <tr v-show="showEclssTotals">
                <th>- Human factors</th>
                <td>{{ formatNumber(results.eclss.human.mass) }}</td>
                <td>{{ formatNumber(results.eclss.human.massISRU) }}</td>
                <td>{{ formatNumber(results.eclss.human.power) }}</td>
                <td>{{ formatNumber(results.eclss.human.volume) }}</td>
              </tr>
              <tr v-show="showEclssTotals">
                <th>- Biomass</th>
                <td>{{ formatNumber(results.eclss.biomass.mass) }}</td>
                <td>{{ formatNumber(results.eclss.biomass.massISRU) }}</td>
                <td>{{ formatNumber(results.eclss.biomass.power) }}</td>
                <td>{{ formatNumber(results.eclss.biomass.volume) }}</td>
              </tr>
              <tr>
                <td colspan="5">&nbsp;</td>
              </tr>
              <tr>
                ...
                <td>{{ formatNumber(results.payload.mass) }}</td>
                <td>{{ formatNumber(results.payload.massISRU) }}</td>
                <td>{{ formatNumber(results.payload.power) }}</td>
                <td>{{ formatNumber(results.payload.volume) }}</td>
              </tr>
              <tr>
                <td colspan="5">&nbsp;</td>
              </tr>
              <tr>
                ...
                <td>{{ formatNumber(results.addBiomass.mass) }}</td>
                <td>{{ formatNumber(results.addBiomass.massISRU) }}</td>
                <td>-</td>
                <td>-</td>
              </tr>
              <tr>
              ...
              >
                <th>+ Power system</th>
                <td>{{ formatNumber(results.power.totals.mass) }}</td>
                <td>{{ formatNumber(results.power.totals.massISRU) }}</td>
                <td>-</td>
                <td>{{ formatNumber(results.power.totals.volume) }}</td>
              </tr>
              <tr v-show="showPowerTotals">
                <th>- Primary power generation</th>
                <td>{{ formatNumber(results.power.primary.mass) }}</td>
                <td>{{ formatNumber(results.power.primary.massISRU) }}</td>
                <td>-</td>
                <td>{{ formatNumber(results.power.primary.volume) }}</td>
              </tr>
              <tr v-show="showPowerTotals">
                <th>- Secondary power generation</th>
                <td>{{ formatNumber(results.power.secondary.mass) }}</td>
                <td>{{ formatNumber(results.power.secondary.massISRU) }}</td>
                <td>-</td>
                <td>{{ formatNumber(results.power.secondary.volume) }}</td>
              </tr>
              <tr v-show="showPowerTotals">
                <th>- Battery storage</th>
                <td>{{ formatNumber(results.power.battery.mass) }}</td>
                <td>{{ formatNumber(results.power.battery.massISRU) }}</td>
                <td>-</td>
                <td>{{ formatNumber(results.power.battery.volume) }}</td>
              </tr>
              <tr v-show="showPowerTotals">
                <th>- Regenerative fuel cell storage</th>
                <td>{{ formatNumber(results.power.fuelCell.mass) }}</td>
                <td>{{ formatNumber(results.power.fuelCell.massISRU) }}</td>
                <td>-</td>
                <td>{{ formatNumber(results.power.fuelCell.volume) }}</td>
              </tr>
              <tr>
                <td colspan="5">&nbsp;</td>
              </tr>
              <tr>
                ...
                <td>{{ formatNumber(results.heat.massISRU) }}</td>
      ...
      >
        ...
        <div class="result-chart">
          <div id="crew-commitments" style="width: 100%; height: 400px"></div>
        </div>
        ...
        <div id="crew-table" class="table-responsive">
          <table class="table">
            ...
            <tbody>
              <tr class="result-totals">
                <th>TOTAL</th>
                <td>{{ formatNumber(crewResults.totals.mission) }}</td>
            ...
            <tfoot v-show="showCrewDetails">
              <tr>
                <th>Air</th>
                <td>{{ formatNumber(crewResults.air.mission) }}</td>
              ...
              <tr v-show="showCrewDetails">
                <th>Food</th>
                <td>{{ formatNumber(crewResults.food.mission) }}</td>
              ...
              <tr v-show="showCrewDetails">
                <th>Thermal</th>
                <td>{{ formatNumber(crewResults.thermal.mission) }}</td>
              ...
              <tr v-show="showCrewDetails">
                <th>Waste</th>
                <td>{{ formatNumber(crewResults.waste.mission) }}</td>
              ...
              <tr v-show="showCrewDetails">
                <th>Water</th>
                <td>{{ formatNumber(crewResults.water.mission) }}</td>
              ...
              <tr v-show="showCrewDetails">
                <th>EVA</th>
                <td>{{ formatNumber(crewResults.eva.mission) }}</td>
              ...
              <tr v-show="showCrewDetails">
                <th>Human factors</th>
                <td>{{ formatNumber(crewResults.human.mission) }}</td>
              ...
              <tr v-show="showCrewDetails">
                <th>Biomass</th>
                <td>{{ formatNumber(crewResults.biomass.mission) }}</td>
...
const fluxRatio = computed(() => {
  ...
  const CO2Flux = Math.abs(
    100 -
      (formData.value.mission.atmosphere ? closureIsruCO2 : closureNoIsruCO2)
  );
...
const dayAveragedDemand = computed(() => {
  return (
    (peakElectricalDemand.value * 2) / 3 + (nightElectricalDemand.value * 1) / 3
  );
});
...
const thermalLoad = computed(() => {
  ...
  const ISRUQuantityCooling = formData.value.biomass.lighting.baseline.cooling;
...
const totalAtDestinationVolume = computed(() => {
  ...
  const biomassQuantityVolume = formData.value.biomass.lighting.biomass.volume;
...
function calcECLSSAir() {
  ...
  results.eclss.air.mass = Math.ceil(perDayQuantityMass + baselineQuantityMass);
  ...
  const perDayQuantityVolume =
    formData.value.support.air.volume * CMdays.value * fluxRatio.value + 0.25; // 0.25 is an attempt to help JS round better
...
function calcECLSSFood() {
  ...
  const perDayQuantityPower = formData.value.support.food.power * CMdays.value;
  const baselineQuantityPower =
...
function calcECLSSeva() {
  ...
  results.eclss.eva.mass = Math.ceil(perDayQuantityMass + baselineQuantityMass);
...
function calcECLSSBiomass() {
  ...
  crewResults.biomass.available =
    roundTwo((crewResults.biomass.fractionCM / availableHours.value) * 100) +
    "%";
}
function calcECLSSThermal() {
  ...
  crewResults.thermal.available =
    roundTwo((crewResults.thermal.fractionCM / availableHours.value) * 100) +
    "%";
}
...
function calcPowerBattery() {
  ...
  const energyStorageInBatteries =
    (overnightPowerDeficeit.value * formData.value.electrical.storage) / 100;
  ...
  results.power.battery.mass =
    overnightPowerDeficeit.value === 0 ? 0 : Math.ceil(massIncludingResupply);

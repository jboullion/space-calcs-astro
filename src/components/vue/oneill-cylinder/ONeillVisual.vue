...
function setupAxesHelper() {
  const axesHelper = new THREE.AxesHelper(props.formData.structure.radius / 10); // 500 is size
...
function buildCylinderStation(material: THREE.Material) {
  ...
  arcShape.absarc(0, 0, props.formData.structure.radius, 0, Math.PI * 2, false);
